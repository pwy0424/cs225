...
class BinaryTree
{
	...
	void mirror_helper(Node *input);
        ...
        int sumDistances_helper(Node * input, int temp) const;
	void printPaths_helper(Node * input, vector<int> temp) const;
	bool isOrdered_helper(Node *input)  const;
        /**
