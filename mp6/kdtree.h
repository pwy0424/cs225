...
class KDTree
{
    ...
    private:
		...
		void sort(vector< Point<Dim> > & Points, int curDim, int a, int b);

		void build(vector<Point<Dim> > & Points, int curDim, int a, int b);
    
		Point<Dim> find(const Point<Dim> & query, int cur, int curDim, int a, int b) const;
	    /**
